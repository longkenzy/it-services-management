<?php
/**
 * Fix Auto Increment cho bảng maintenance_requests
 * File: fix_maintenance_requests_auto_increment.php
...
echo "<h2>Fixing Auto Increment cho bảng maintenance_requests</h2>";

try {
    // Bước 1: Kiểm tra cấu trúc bảng hiện tại
    echo "<p>1. Kiểm tra cấu trúc bảng maintenance_requests...</p>";
    ...
    $sql5 = "ALTER TABLE maintenance_requests AUTO_INCREMENT = $nextId";
    $pdo->exec($sql5);
    ...
    echo "<p>Bảng maintenance_requests hiện tại có thể tạo ID mới bắt đầu từ: " . $nextId . "</p>";
