-- Script sửa lỗi đơn giản cho bảng deployment_cases
-- Chạy từng lệnh một theo thứ tự

-- 1. Xóa dữ liệu lỗi (ID = 0)
DELETE FROM deployment_cases WHERE id = 0;
...
UPDATE deployment_cases SET created_at = CURRENT_TIMESTAMP, updated_at = CURRENT_TIMESTAMP 
