 ...
 * File: assets/js/maintenance_requests.js
 * Purpose: JavaScript functionality for maintenance requests page
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function exportMaintenanceRequestsToExcel() {
        ...
        // Tạo URL export
        const exportUrl = 'api/export_maintenance_requests.php';
