 ...
 * File: fix_maintenance_tasks_auto_increment.php
...
echo "<h2>Fixing Auto Increment cho bảng maintenance_tasks</h2>";

try {
    // Bước 1: Kiểm tra cấu trúc bảng hiện tại
    echo "<p>1. Kiểm tra cấu trúc bảng maintenance_tasks...</p>";
    ...
    $sql5 = "ALTER TABLE maintenance_tasks AUTO_INCREMENT = $nextId";
    $pdo->exec($sql5);
    ...
    echo "<p>Bảng maintenance_tasks hiện tại có thể tạo ID mới bắt đầu từ: " . $nextId . "</p>";
